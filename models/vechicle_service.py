...
class VechicleService(models.Model):
    ...
    def total_amount(self):
        for i in self:
            ...
            """the total amount function is used to calculate the total amount for products used for repair"""
    ...
    def labor_total(self):
        for rec in self:
            ...
            """labor total function is used to calculate the total cost of all labors worked for the repair service"""
